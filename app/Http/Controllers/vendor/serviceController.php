...
class serviceController extends Controller
{
    ...
    public function orderService(){
      $orders=Orders::
       ...
       ->select('products.product','countries.country','states.state','areas.area','districts.district','categories.category','sub_categories.subcategory','services.id as service_id','services.price','services.type','services.desc','services.is_price_show','services.currency','service_requests.status','orders.id as order_id')
       ->get();
