                                    ...
                                    <li class="dropdown user-dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                            ...
                                            <div class="user-toggle">
                                                 <div style="margin-right:20px" class="user-name sm ">
                                             <em class='fas fa-wallet'></em>
                                                  Wallet Rs. {{auth()->user()->balance}}
                                                </div>
                                                <div class="user-avatar sm">
                                                    <em class="icon ni ni-user-alt"></em>
                                                </div>
                                                <div class="user-name dropdown-indicator d-none d-sm-block">Hello {{auth()->user()->name}}</div>
                                            </div>
                                        </a>
                                                ...
                                                <ul class="link-list">
                                                    <li>
                                                        <form method="post" action="{{route('logout')}}">
                                                            @csrf<button type="submit"><em class="icon ni ni-signout"></em><span>Sign out</span></button></form></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </li><!-- .dropdown -->
