...
<div class="nk-block nk-block-lg">
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-inner">
                                                <form action="{{route('admin-subsc-save')}}" class="form-validate is-alter" method="post">
                                                	@csrf
                                                    <div class="row g-gs">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="form-label" for="fva-topics">  Title</label>
                                                               <div class="form-control-wrap">
                                                                    <input type="text" class="form-control" id="fva-subject" name="title" required placeholder="title">
                                                                </div>
                                                            </div>
                                                        </div>
                                                          <div class="col-md-6">
                                                    ...
                                                    <div class="row g-gs">
                                                          <div class="col-md-6">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="form-control-wrap ">
                                                                    <select class="form-control form-select" id="product" name="product_id[]" data-placeholder="Select a option"  data-search="on" required multiple="true">
