                    ...
                    <div class="container">
                        <div class="d-flex align-items-center">
                            <div class="topbar-left">
                                <a href="#" class="text-gray-110 font-size-13 hover-on-dark">Welcome
                                    @if(\Auth::check())
                    ...
                    <div class="container my-0dot5 my-xl-0">
                        <div class="row align-items-center">
                                                ...
                                                <div class="js-scrollbar u-sidebar__body">
                                                    <div id="headerSidebarContent" class="u-sidebar__content u-header-sidebar__content">
                                                        ...
                                                        <ul id="headerSidebarList" class="u-header-collapse__nav">
                                                            <!-- Value of the Day -->
                                                            <li class="">
                                                                <a class="u-header-collapse__nav-link font-weight-bold" href="{{route('user-subs-plan')}}">Our Plans</a>
                                                            </li>
                            ...
                            <div class="col d-none d-xl-block">
                                <form class="" method="post" action="{{route('user-search')}}">
                                    @csrf
                                    <label class="sr-only" for="searchproduct">Search</label>
                                    <div class="input-group">
                                        <input type="text" class="form-control py-2 pl-5 font-size-15 border-right-0 height-40 border-width-2 rounded-left-pill border-primary" name="key" id="searchproduct-item" placeholder="Search for Products" aria-label="Search for Products" aria-describedby="searchProduct1" required>
                                    ...
                                    <ul class="d-flex list-unstyled mb-0 align-items-center">
                                        ...
                                        <li class="col pr-xl-0 px-2 px-sm-3 d-xl-none">
                                            <a href="http://transvelo.github.io/electro-html/2.0/html/shop/cart.html" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart">
                                                <i class="font-size-22 fas fa-wallet"></i>
                                            ...
                                            <div id="basicDropdownHoverInvoker" class="text-gray-90 position-relative d-flex " data-toggle="tooltip" data-placement="top" title="Cart"
                                                ...
                                                data-unfold-animation-out="fadeOut">
                                                  @if(\Auth::check())
                                                    ...
                                                    <span class="d-none d-xl-block font-weight-bold font-size-16 text-gray-90 ml-3">Rs.{{auth()->user()->balance}}.00</span>
                                                    ...
                                                    <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                                        <ul class="navbar-nav u-header__navbar-nav">
                                                            <li class="nav-item u-header__nav-item"
                                                                data-event="hover"
                                                                data-position="left">
                                                                <a href="{{route('user-subs-plan')}}" class="nav-link u-header__nav-link font-weight-bold">Our Plans</a>
                                                            </li>
                                                            <li class="nav-item u-header__nav-item"
                                                                data-event="hover"
                                                                data-position="left">
                                                            ...
                                                            <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                                                ...
                                                                data-position="left">
                                                                <a id="basicMegaMenu" class="nav-link u-header__nav-link u-header__nav-link-toggle" href="javascript:;" aria-haspopup="true" aria-expanded="false">{{$category->category}}</a>
                                ...
                                <div id="navBar" class="collapse navbar-collapse u-header__navbar-collapse">
                                    <ul class="navbar-nav u-header__navbar-nav">
                                        ...
                                        <li class="nav-item hs-has-mega-menu u-header__nav-item"
                                            ...
                                            data-position="left">
                                            <a  class="nav-link u-header__nav-link u-header__nav-link-toggle text-sale" href="{{route('user-subs-plan')}}">Super Deals</a>
