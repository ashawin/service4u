                            ...
                            <div class="handheld-navigation hidden-lg-up" id="default-hh-header"> 
                                ...
                                <ul id="menu-all-departments-menu-1" class="nav nav-inline yamm">
                                    <li class="highlight menu-item animate-dropdown ">
                                        <a title="Value of the Day" href="{{route('user-subs-plan')}}">Our Plans</a>
                                    </li>
                                    <li class="highlight menu-item animate-dropdown ">
                                        <a title="Top 100 Offers" href="{{url('/')}}">Top 100 Offers</a>
                                    </li>
                                     @foreach($categories as $category)
                                   
                                    <li class="yamm-tfw menu-item menu-item-has-children animate-dropdown dropdown">
                                        <a title="Computers &amp; Accessories" href="{{url('/')}}" data-toggle="dropdown" class="dropdown-toggle" aria-haspopup="true">{{$category->category}}</a>
                                    ...
                                    @endforeach
                                      ...
                                      <li class="highlight menu-item animate-dropdown ">
                                        <a title="Value of the Day" href="{{url('contact')}}">Contact Us</a>
                                    </li>
                                     @if(\Auth::check())
                                     <li class="highlight menu-item animate-dropdown ">

                                        <a title="Value of the Day" href="{{url('profile')}}">Profile</a>
                                    </li>
                                    <li class="highlight menu-item animate-dropdown ">
                                ...
                                {{ csrf_field() }}
                                    ...
                                    @else
                                     <li class="highlight menu-item animate-dropdown ">
                                        ...
                                        <a title="Value of the Day" href="{{url('user/login')}}">Login/Signup</a>
                                    </li>
